...
export function GrantXpButton({ id, name, level, xp }: { id: string; name: string; level: number; xp: number }) {
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="system-panel system-panel-violet max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription>
              LV.{level} · {xp}/{requiredXpForLevel(level)} XP. This applies immediately — no approval queue.
            </DialogDescription>
          </DialogHeader>
